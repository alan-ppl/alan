...
class TestProblem():
    def __init__(self, problem, moments, known_moments=None, known_elbo=None, moment_K=30, elbo_K=30, elbo_iters=20, importance_N=1000, stderrs=6, split=no_checkpoint):
        """
...
#
#    def test_all(self, sampling_type):
#        self.test_moments_sample_marginal(sampling_type)
#        self.test_moments_importance_sample(sampling_type)
#        self.test_moments_ground_truth(sampling_type)
#
