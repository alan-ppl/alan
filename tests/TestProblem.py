...
class TestProblem():
    def __init__(self, problem, moments, known_moments=None, known_elbo=None, moment_K=30, elbo_K=30, elbo_iters=20, elbo_gap_cat=1, elbo_gap_perm=1, importance_N=1000, stderrs=6, split=no_checkpoint):
        """
